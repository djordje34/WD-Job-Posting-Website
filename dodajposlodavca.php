...
<html>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <form method='get' class='formContainer' action='dodajposlodavca.php'>
   <div class='input-group form-group formedGroupAddon' style='border-radius:0 10px 10px 0;'>
                               ...
                               <input class='textContainer' type='text' name='username' class='form-control' placeholder='Unesite korisničko ime' required>
                           </div> 

                           <div class='input-group form-group formedGroupAddon' style='border-radius:0 10px 10px 0;'>
                           <div class='input-group-prepend groupAddon' >
                           <span class='input-group-text'><i class='fas fa-key normalIconContainer'></i></span>
                       </div>
                       <input class='textContainer' type='password' name='password' class='form-control' placeholder='Unesite lozinku' required>
                   </div> 
               ...
               <input class='textContainer' type='text' name='Naziv_firme' class='form-control' placeholder='Ime kompanije korisnika' required>
           </div> 
   ...
   <div class='input-group form-group formedGroupAddon'>
    ...
    if(isset($_GET['dodaj']))
    {
        ...
        if (count($errors) == 0)
        {
            ...
            mysqli_stmt_prepare($db1, "INSERT INTO poslodavac (id_p, struka) VALUES(?,?)");
            mysqli_stmt_bind_param($db1, "ss", $id, $_GET['struka']);
            mysqli_stmt_execute($db1);

            mysqli_stmt_prepare($db1, "INSERT INTO firme (Naziv_firme, id_poslodavca) VALUES(?,?)");
            mysqli_stmt_bind_param($db1, "ss", $_GET['Naziv_firme'], $id);
            mysqli_stmt_execute($db1);
        }
