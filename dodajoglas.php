...
<head>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
     <style>
        body{ font: 14px sans-serif; text-align: center; background-repeat:repeat; min-height:100% !important;}
    </style>
...
<div class="input-group form-group" style="background-color:#FFC312;margin:0 0 10px 0; border:1px solid black;">
                            ...
                            <input type="text" name="lokacija" class="form-control" placeholder="Lokacija posla" required>
                        </div> 
                        <div class="input-group form-group" style="background-color:#FFC312;margin:0 0 10px 0; border:1px solid black;">
                            <div class="input-group-prepend">
                    ...
                    <div class="input-group form-group" style="background-color:#FFC312;margin:0 0 10px 0; border:1px solid black;">
                            ...
                            <textarea rows="4" cols="50" name="opis" class="form-control" placeholder="Opis posla" required></textarea>
                            </div>
                            ...
                            <input style="border:1px solid black;"type="date" id="start" name="rok" value="202-01-01" min="2022-01-01" max="2023-12-31">
                            </div>      

  <button type="submit" class="btn btn-danger submitBtnStyle" name="add_new">Postavi oglas</button>
  </div>
</form>
</div>
</section>
